...
### 17.1 Statistical Anomaly Detection

**Method:** Build a statistical model of normal signal behavior (mean, variance, spectral shape, feature correlations). Flag deviations from the model.
