# NeuroShield Glossary & Formal Definitions

NeuroShield operates at the intersection of neuroscience, cybersecurity, and control theory. To maintain academic and engineering rigor, the following terms are formally defined within the scope of this repository.

> [!NOTE]
> NeuroShield is an **evolving research platform and reference implementation**. The phenomena described below are theoretical threat models designed for simulation and mitigation research, heavily inspired by the foundational work in the [qinnovates/neurosecurity](https://github.com/qinnovates/neurosecurity) repository.
...
A methodology and structured dataset for evaluating the severity and physical feasibility of neurosecurity threats, yielding a Neural Implant Severity Score (NISS). The NeuroShield repository uses a stubbed version of the 161-technique `qtara-registrar.json` datalake for simulation mapping.
