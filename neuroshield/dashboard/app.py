...
def init_system():
    ...
    ti = ThreatIntelligence(registry_path="neuroshield/core/data/qtara_stub.json")
...
# --- Sidebar Controls ---
st.sidebar.title("NeuroShield Control")
...
# --- Main Dashboard ---
st.title("NeuroShield Live Dashboard")
