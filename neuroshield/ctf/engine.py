"""
NeuroShield CTF Engine — Gamified neurosecurity challenge framework.
    ...
    return Challenge(
        ...
        objectives=[
            ...
            ChallengeObjective(
                ...
                points=100,
                hint="Check neuroshield.core.ml_decoder for the bandpass filter.",
            ),
            ChallengeObjective(
                objective_id="obj_3",
...
def print_challenge_list(challenges: List[Dict[str, str]]) -> None:
    ...
    print("=" * 70)
    print(" NeuroShield CTF — Available Challenges")
    print("=" * 70)
    ...
    print()
    print(f"  {len(challenges)} challenges available. Use: neuroshield ctf start <ID>")
    print("=" * 70)
...
def print_scoreboard(scoreboard: Scoreboard) -> None:
    ...
    print("=" * 60)
    print(f" NeuroShield CTF Scoreboard — {scoreboard.player_name}")
    print("=" * 60)
