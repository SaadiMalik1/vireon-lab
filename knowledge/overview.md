...
- **[System Architecture Reference](architecture.md)**: Detailed technical specifications for Config, Telemetry RBAC, Middleware, Audit Logging, and Async Workers.
- **[Package Reference](package_reference.md)**: Developer quickstart and API usage guide for the `vireon_lab` Python package.
